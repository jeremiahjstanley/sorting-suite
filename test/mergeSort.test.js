...
describe('MergeSort', () => {
  ...
  it('should alphabetize a letter array', () => {
    ...
    expect(mergeSort(array)).to.deep.equal(['b', 'c', 'q', 'z']);
  })

  it('should sort floating point integers', () => {
    array = [1.2, 1.12, 1 , 2, 1.25]

    expect(mergeSort(array)).to.deep.equal([1, 1.12, 1.2, 1.25, 2]);
  })

  it('should sort arrays with duplicate values', () => {
    array = [3, 3, 1 , 2, 5]

    expect(mergeSort(array)).to.deep.equal([1, 2, 3, 3, 5]);
  })

  it('should sort negative numbers', () => {
    array = [-5, 0, 1 , 3, -2]

    expect(mergeSort(array)).to.deep.equal([-5, -2, 0, 1, 3]);
  })
